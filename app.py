...
function_definitions_llm = [
    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "weekday": {"weekday": {"type": "integer", "enum": [0, 1, 2, 3, 4, 5, 6]}}
            },
    ...
    },
    {
        ...
        "description": "Scans a directory for documents and generates an index, saving it as a JSON file.",
        "parameters": {
            "type": "object",
            "properties": {
                "doc_dir_path": {
                ...
                "output_file_path": {
                    "type": "string",
                    "description": "Path where the generated JSON index should be saved.",
                ...
                "file_extensions": {
                    ...
                    "description": "List of file extensions to include in the index (e.g., ['.txt', '.pdf']).",
                    "default": [".txt", ".pdf", ".md"]
                }
            },
